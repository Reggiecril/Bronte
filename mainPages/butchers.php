...
<div class="container">
 <div class="row">
  ...
  <div class="col-lg-12 col-md-12 col-sm-12">
   <img src="../assets/img/butcher-cover.png" class="centered-img hidden-xs"></img>
  </div>
 ...
 <div class="row">
  ...
  <div class="col-lg-9 col-md-9 col-sm-9">
   <div class="row">
	...
	<?php
	$product_array = $db_handle->runQuery("SELECT * FROM product WHERE PRODUCT_TYPE = 'Meat'");
			    ...
			    <?php 
			        ...
			        echo '<div class="'.$col_class.'"><a href="../products/productpage.php?PRODUCT_NAME='.$product_array[$key]["PRODUCT_NAME"].'">'.$img.'
      				...
      				<input type="submit" value="Add to basket" class="buynow-button" />
      				  ...
      				  $_SESSION['product'] = $row['PRODUCT_DESCRIPTION'];
            
            $_SESSION['productname'] = ''.$product_array[$key]["PRODUCT_NAME"].'';
