...
<div class="container">
 <div class="row">
  ...
  <div class="col-lg-12 col-md-12 col-sm-12">
   <img src="../assets/img/fishmonger-cover.png" class="centered-img hidden-xs"></img>
  </div>
 ...
 <div class="row">
  ...
  <div class="col-lg-9 col-md-9 col-sm-9">
   <div class="row">
	...
	<?php
	$product_array = $db_handle->runQuery("SELECT * FROM PRODUCT WHERE PRODUCT_TYPE = 'Seafood' ORDER BY PRODUCT_ID ASC");
