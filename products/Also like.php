...
?>
    					...
    					$img ='<img class="centered-img" src="../assets/img/'.($row["IMAGE_FILENAME"]).'" />';
    					echo '<div  style="width: 20%;margin: 0 auto;display: inline-block;""><a href="../products/productpage.php?PRODUCT_NAME='.$row["PRODUCT_NAME"].'">'.$img.'
      					<h5 class="product-title">'.$row["PRODUCT_NAME"].'<br><br></h5></a>
      					<h5 class="product-title">'.$rating.'<br><br></h5>
      					<h5 class="product-desc">'.$row["PRODUCT_DESCRIPTION"].'<br><br></h5>
      					<h5 class="product-price">£'.$row["PRODUCT_PRICE"].'.00<br><br></h5>
      					</div>';
      					?>