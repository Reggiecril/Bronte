...
echo "<table border =1><tr><th>Name</th><th>Description</th><th>Price</th><th>Available Stock</th><th>Image</th><th>Amend</th><th>Delete</th></tr>";
	while ($row = mysqli_fetch_assoc($result)){
						...
						echo "<tr><td>" . $row["PRODUCT_NAME"]. 
						      ...
						      "</td><td>" . '<a href="bakery/amendproduct.php?id='. $row['PRODUCT_ID'].'">Amend</a>'.
						      "</td><td>" . '<a href="bakery/delete.php?id='. $row['PRODUCT_ID'].'">Delete</a>'.
						      "</td></tr> " ;
...
<h3 class="table-links"> Add A New Product </h3>
    <form name="form1" method="post" action="bakery/insertproduct.php">
        <table border="0">
            <tr> 
                <td>Product Name</td>
