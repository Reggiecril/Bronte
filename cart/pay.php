...
<div class="container">
	<div class="row">
		<div class="col-lg-12 col-md-12">
			...
			<h3 class="table-links"> Pay Now </h3>
...
?>
    ...
    <div class="panel-heading">
       <a data-toggle="collapse" href="#collapse-panel-card"><h3 class="panel-title"> Card Details & Collection Times<span class="caret"></span></h3></a>
    </div>
     <div id="collapse-panel-card" class="panel-collapse collapse">
    <div class="panel-body">
      <div class="form-group">
        <form method="post" action="transaction.php">
   
                <label for="email">Your Full Name:</label>
        		<input type="text" placeholder="Full Name" name="payee" required="required"/>
        		<span class="error">* Required </span>
                
                <label for="email">Card Number:</label>
        		<input type="tel" pattern="^\d{16}" placeholder="0000000000000000" name="cardnumber" required="required"/>
        		<span class="error">* Required </span>
        		
        		<label for="email">Sort Code:</label>
        		<input type="text" placeholder="00-00-00" name="sortcode" required="required"/>
        		<span class="error">* Required </span>
        		
        		<label for="email">Security Code:</label>
        		<input type="tel" pattern="^\d{3}" placeholder="000" name="back" required="required"/>
        		<span class="error">* Required </span>
        		
        		<label for="email">Expiry Date:</label>
        		<input type="text" placeholder="00/00" name="expirydate" required="required"/>
        		<span class="error">* Required </span>
...
<a href="../mainPages/shop.php?action=display<?php $_SESSION["cart_item"] ?>&action=add&PRODUCT_NAME=<?php echo $product_array[$key]["PRODUCT_NAME"]; ?>"><h3 class="table-links"> Continue Shopping  </h3></a>
